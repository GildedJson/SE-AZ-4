...
public class SymbolTable {
    ...
    public SymbolTable(Memory memory) {
        ...
        keyWords.put("true", CodeGeneratorFacade.newAddress(1, varType.Bool, TypeAddress.Immediate));
        keyWords.put("false", CodeGeneratorFacade.newAddress(0, varType.Bool, TypeAddress.Immediate));
    }
